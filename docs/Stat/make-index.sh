...
echo "<h4>Reproducibility of calorimetric studies of the kinetics of SUFEX reactions:</h4>" >> index.html
...
do
  name=`basename $i .svg`
  echo " <li><a href=\"$name.svg\"><img src=\"$name.svg\" height=\"100%\"></a></li>" >> index.html
done
echo "</ul>" >> index.html
