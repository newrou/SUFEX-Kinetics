...
set output "SUFEX-T20.svg"
set xrange [0:40]
#set key samplen -1 spacing 1.3 font ",26" box lw 0
#set nokey
plot \
     "SuFEx-R1-BSF-T20-6-8-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 1 ti "BSF", \
     "SuFEx-R1-BSF-T20-6-10-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 1 ti "BSF", \
     "SuFEx-R1-BSF-NO2-T20-6-13-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "BSF-NO2", \
     "SuFEx-R1-BSF-NO2-T20-6-15-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "BSF-NO2"
