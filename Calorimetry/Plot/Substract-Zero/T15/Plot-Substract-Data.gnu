...
set output "BSF-DCM-T15.svg"
set title "BSF - DCM T15" 
set xrange [0:50]
set key
plot \
     "DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "DCM", \
     "BSF-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 1 ti "BSF", \
     "BSF-DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF - DCM"


set output "BSF-CH3-DCM-T15.svg"
set title "BSF-CH3 - DCM T15" 
set xrange [0:50]
set key
plot \
     "DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "DCM", \
     "BSF-CH3-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 1 ti "BSF-CH3", \
     "BSF-CH3-DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF-CH3 - DCM"


set output "BSF-NO2-DCM-T15.svg"
set title "BSF-NO2 - DCM T15" 
set xrange [0:50]
set key
plot \
     "DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "DCM", \
     "BSF-NO2-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 1 ti "BSF-NO2", \
     "BSF-NO2-DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF-NO2 - DCM"
...
plot \
     ...
     "BSF-CH3-DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "BSF-CH3 - DCM", \
     "BSF-NO2-DCM-T15.dat" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF-NO2 - DCM"
