...
#set nokey
plot \
     "SuFEx-R1-BSF-T20-6-10-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "20°", \
     "SuFEx-R1-BSF-T20-6-8-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "20°", \
     "SuFEx-R1-BSF-T25-1-29-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-T25-1-30-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-T25-1-31-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-T25-2-3-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-T25-2-5-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-T25-2-7-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
...
#set nokey
plot \
     "SuFEx-R1-BSF-CH3-2-19-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-CH3-2-21-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-CH3-2-23-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
     "SuFEx-R1-BSF-CH3-2-25-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "25°", \
