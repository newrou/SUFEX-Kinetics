...
#set nokey
plot \
     "SuFEx-R1-BSF-T30-5-21-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "BSF", \
     "SuFEx-R1-BSF-T30-5-22-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 2 ti "BSF", \
     "SuFEx-R1-BSF-CH3-T30-6-1-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF-Me", \
     "SuFEx-R1-BSF-CH3-T30-6-3-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 3 ti "BSF-Me", \
     "SuFEx-R1-BSF-NO2-T30-5-26-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 4 ti "BSF-NO2", \
     "SuFEx-R1-BSF-NO2-T30-5-29-20.csv" using (($1)/3600):(1000*($2)) with lines linestyle 4 ti "BSF-NO2"
quit
